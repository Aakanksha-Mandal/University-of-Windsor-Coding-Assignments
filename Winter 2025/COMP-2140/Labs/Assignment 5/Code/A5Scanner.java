			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -15:
						break;
					case 15:
						{ return new Symbol(A5Sym.EQ); }
					case -16:
						break;
					case 16:
						{ return new Symbol(A5Sym.NE); }
					case -17:
						break;
					case 17:
					...
					case -18:
						break;
					case 18:
						{ return new Symbol(A5Sym.QUOTEDSTRING, yytext().replace('\'', '"')); }
					case -19:
						break;
					case 19:
						{ yybegin(COMMENT); }
					...
					case -23:
						break;
					case 23:
						{ return new Symbol(A5Sym.REAL_T); }
					case -24:
						break;
					case 24:
